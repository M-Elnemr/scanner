                ...
                {sortedHotels.map((th, i) => (
                  <Card key={i}>
                    <CardContent className="space-y-1.5 pt-6">
                      ...
                      {th.hotel?.latitude != null && th.hotel?.longitude != null && (
                        <a
                          href={mapDirectionsUrl(th.hotel.latitude, th.hotel.longitude, th.city)}
                          target="_blank"
                          rel="noreferrer"
...
function mapDirectionsUrl(hotelLat: number, hotelLng: number, city: string | undefined): string {
